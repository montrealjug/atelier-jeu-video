...
### ⚙️ Group 2 — Tinkerer *(Resource files)*
...
### 📖 Group 3 — Code Reader *(Understanding scripts)*
...
### 💻 Group 4 — Coder *(Writing new code)*
...
**Option B — With Git (for the curious)**
